...
SELECT market_day FROM market_date_info; --days that market was open
 SELECT DISTINCT market_day FROM market_date_info; --the market is only open on Wed and Sat 
